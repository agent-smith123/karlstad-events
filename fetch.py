#!/usr/bin/env python3
"""
Event Calendar - Working Version
Uses requests + BeautifulSoup for reliable fetching
"""
...
def fetch_source(source):
    ...
    try:
        ...
        for elem in soup.find_all(['article', 'div', 'li'], class_=re.compile('event|evenemang', re.I)):
            text = elem.get_text()
